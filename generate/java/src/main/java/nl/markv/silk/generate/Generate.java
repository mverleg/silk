...
import static nl.markv.silk.SilkVersion.schemaPath;
...
public class Generate {
	...
	public static void generateSilkObjects(
		...
		URL source = notNull(
				Generate.class.getResource(schemaPath().toString()),
				"could not find schema file as class resource at '" + schemaPath() + "'"
		);
